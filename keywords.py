...
#   plain text:             "some text"     ==>  "some text"
#   augmentable question:   "some text<*"   ==>  "some text <phrase>?"
#   aumentable statement:   "some text<@"   ==>  "some text <phrase>.
...
__keywords = [
    ...
    KwResponse("WHY DON'T YOU", [
        "Do you really believe I don't<*",
        "Perhaps in good time I will<@"
        "Do you want me to<*"
    ]),
    KwResponse("WHY CAN'T I", [
...
_no_keyword_found_resp = \
    KwResponse(NO_KEY_FOUND, ["Say, do you have any psychological problems?",
...
_repeated_input_resp = \
    KwResponse(REPEATED_INPUT, ["Why did you repeat yourself?",
